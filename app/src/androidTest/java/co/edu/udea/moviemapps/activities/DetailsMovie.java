...
public class DetailsMovie {
    ...
    public void testGenerated() {
        ...
        idlingResource = startTiming(5300);
        // Click at CardView with child index 1 of parent with id R.id.movies_list
        onView(withId(R.id.movies_list)).perform(scrollToPosition(1));
        onView(nthChildOf(withId(R.id.movies_list), 1)).perform(click());
